...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent_registry_add_custom,
            commands::agent_registry_update_custom,
            commands::agent_registry_remove_custom,
            commands::list_skill_versions,
            commands::basin_latest_versions,
